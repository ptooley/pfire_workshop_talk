...
\begin{frame}
  ...
  \begin{block}{Image Registration}
    Image registration is the process by which one image an image is transformed by displacing
    pixels to match another image as closely as possible
  \end{block}
  \begin{block}{}
  ...
  \begin{itemize}
    ...
    \item Digital Volume Correlation (Stress/strain analysis)
      \begin{itemize}
        ...
        \item Differentiation yields strain field in sample
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \alert Problem: this form of the equation uses the already registered image.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \alert Another problem: equation is underdetermined!
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Add a smoothing constraint $\nabla^2 \vec{R}(\vec{x} = 0 $
    \item Displacement is smooth is second derivative is zero everywhere
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item[~]
    \item MareNostrum files: /gpfs/projects/nct00/nct00016/
    \item[~]
